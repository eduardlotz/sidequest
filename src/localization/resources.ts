...
export const englishUi = {
  ...
  about: {
    ...
    step5: "Spend earned points on red ropes or a fresh set of cards",
  ...
  timer: {
    ...
    completeAvailableIn: "Complete in {{time}}.",
    completeOrCancel:
...
export const germanUi = {
  ...
  about: {
    ...
    step5: "Gib verdiente Punkte für rote Seile oder neue Karten aus",
  ...
  timer: {
    ...
    completeAvailableIn: "Abschluss in {{time}}.",
    completeOrCancel:

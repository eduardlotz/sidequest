...
export const englishUi = {
  ...
  task: {
    ...
    pickerIntro: "Choose a mood that fits, or pick a specific game",
    pickerMode: "Quest selection mode",
    mood: "Mood",
    game: "Game",
...
export const germanUi = {
  ...
  task: {
    ...
    pickerIntro: "Wähle eine passende Stimmung oder nur ein bestimmtes Spiel",
    pickerMode: "Quest-Auswahlmodus",
    mood: "Stimmung",
    game: "Spiel",

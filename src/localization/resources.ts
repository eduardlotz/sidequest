...
export const englishUi = {
  ...
  about: {
    ...
    step2: "Pick a quest for your library or any game",
  ...
  offers: {
    deckLabel: "Choose from {{count}} quest cards",
    emptyLibrary: "No matching quests in your library for this mood. Choose another mood or change your quest filter in your profile.",
  ...
  profile: {
    ...
    settings: "Settings",
    questOffers: "Quests",
    questOffersLibrary: "Library",
    questOffersFlexible: "Flexible",
    questOffersAll: "All",
    theme: "Theme",
    themeAuto: "Auto",
    themeLight: "Light",
...
export const germanUi = {
  ...
  about: {
    ...
    step2:
      "Such dir eine Quest für deine Bibliothek oder ein beliebiges Spiel aus",
  ...
  offers: {
    deckLabel: "Wähle aus {{count}} Quest-Karten",
    emptyLibrary: "Für diese Stimmung gibt es keine passenden Quests in deiner Bibliothek. Wähle eine andere Stimmung oder ändere den Quest-Filter in deinem Profil.",
  ...
  profile: {
    ...
    questOffers: "Quests",
    questOffersLibrary: "Bibliothek",
    questOffersFlexible: "Flexibel",
    questOffersAll: "Alle",
    theme: "Theme",
    themeAuto: "Auto",
    themeLight: "Hell",

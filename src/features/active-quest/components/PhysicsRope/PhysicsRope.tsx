...
export const MOBILE_RUNNING_TIMER_TOP_RATIO = 0.35;
export const MOBILE_READY_TIMER_TOP_RATIO = 0.152;
export const MOBILE_PAUSED_TIMER_TOP_RATIO = MOBILE_READY_TIMER_TOP_RATIO * 0.8;

...
export const EXPLORE_QUESTS = defineMoodDeck("explore", [
  {
    ...
    completion: "Finish its opening activity or play for 25 active minutes.",
    durationMinutes: 25,
    rewardPoints: 180,
  ...
  },
  {
    ...
    completion: "Reach its first major reveal or play for 30 active minutes.",
    durationMinutes: 30,
    rewardPoints: 200,
  ...
  },
  {
    ...
    completion: "Finish its opening activity or play for 30 active minutes.",
    durationMinutes: 30,
    rewardPoints: 190,
  ...
  },
  {
    ...
    completion: "Finish one level, match, stage, or 30 active minutes.",
    durationMinutes: 30,
    rewardPoints: 200,

...
export const NOSTALGIC_QUESTS = defineMoodDeck("nostalgic", [
  ...
  },
  {
    ...
    completion: "Finish one retro level, match, stage, or 30 active minutes.",
    durationMinutes: 30,
    rewardPoints: 200,
  ...
  {
    id: "old-friend-pick",
    title: "Play an Old Friend's Favorite",
    objective: "The game that best represents a former friend's taste.",
    completion: "Finish one activity they would have chosen first.",
    durationMinutes: 30,
    rewardPoints: 200,
    tipIds: ["borrowedStyle", "cleanExit"],
  },
  ...
  },
  {
    ...
    completion: "Reach the next safe room, checkpoint, or 30 active minutes.",
    durationMinutes: 30,
    rewardPoints: 220,
  ...
  },
  {
    ...
    completion: "Finish its opening chapter, stage, or 30 active minutes.",
    durationMinutes: 30,
    rewardPoints: 200,

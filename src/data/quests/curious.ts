...
export const CURIOUS_QUESTS = defineMoodDeck("curious", [
  {
    ...
    completion: "Reach its first clear goal or play for 30 active minutes.",
    durationMinutes: 30,
    rewardPoints: 200,
  ...
  },
  {
    ...
    completion: "Finish its opening activity or play for 35 active minutes.",
    durationMinutes: 35,
    rewardPoints: 220,
  ...
  },
  {
    ...
    completion: "Reach its first save point or play for 30 active minutes.",
    durationMinutes: 30,
    rewardPoints: 220,

...
export const PROGRESS_QUESTS = defineMoodDeck("progress", [
  ...
  },
  {
    ...
    title: "Give It One Honest Hour",
    objective: "A game you dismissed before learning its real loop.",
    completion: "Play for 60 active minutes, stopping only for genuine discomfort.",
    durationMinutes: 60,
    rewardPoints: 250,
  ...
  },
  {
    ...
    completion: "Play 60 active minutes toward the ending, then save.",
    durationMinutes: 60,
    rewardPoints: 250,
  ...
  },
  {
    ...
    completion: "Finish its opening activity or play for 45 active minutes.",
    durationMinutes: 45,
    rewardPoints: 220,

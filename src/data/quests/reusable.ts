  ...
  ...featureQuests(
    ...
    [
      ...
      [
        ...
        "Fire **ten carefully aimed pistol shots** in a practice area or familiar encounter. Pause to line up each shot; count hits instead of speed.",
        "Zehn gezielte Schüsse",
        "Gib auf einem Übungsplatz oder in einem vertrauten Kampf **zehn gezielte Pistolenschüsse** ab. Ziele vor jedem Schuss in Ruhe und zähle deine Treffer.",
      ],
      [
        "pistol-return",
        ["nostalgic", "progress"],
  ...
  ...featureQuests(
    ...
    [
      [
        ...
        ["focused", "challenge"],
        "Controlled Bursts",
        "During one familiar encounter, fire your rifle in **short bursts with a pause to aim between them**. Finish the encounter or stop after ten minutes.",
        "Kurze Feuerstöße",
        "Schieße in einem vertrauten Kampf mit deinem Gewehr **in kurzen Feuerstößen und ziele dazwischen neu**. Beende den Kampf oder hör nach zehn Minuten auf.",
      ],
      [
        "rifle-new-position",
        ["explore", "curious"],

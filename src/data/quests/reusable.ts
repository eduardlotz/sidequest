...
export const reusableQuests: readonly AuthoredQuestDefinition[] = [
  ...featureQuests(["pistols"], ["Choose a game where you can use pistols.", "Wähle ein Spiel mit Pistolen."], [["pistol-three-encounters", ["focused", "challenge"], "Sidearm Session", "Use **only a pistol for three familiar encounters**. Keep your usual movement and take cover between shots.", "Nur die Seitenwaffe", "Nutze in **drei vertrauten Kämpfen nur eine Pistole**. Bewege dich wie gewohnt und geh zwischen den Schüssen in Deckung."], ["pistol-deliberate-shots", ["focused", "low-energy"], "Ten Deliberate Shots", "Fire **ten carefully aimed pistol shots** in a practice area or familiar encounter. Pause to line up each shot; count hits instead of speed.", "Zehn gezielte Schüsse", "Gib auf einem Übungsplatz oder in einem vertrauten Kampf **zehn gezielte Pistolenschüsse** ab. Ziele vor jedem Schuss in Ruhe und zähle deine Treffer."], ["pistol-return", ["nostalgic", "progress"], "Old Sidearm", "Equip **a pistol you have not used recently**. Finish one familiar encounter with it and decide whether to keep it equipped.", "Alte Seitenwaffe", "Rüste **eine Pistole aus, die du länger nicht benutzt hast**. Schaffe damit einen vertrauten Kampf und entscheide danach, ob du sie weiter nutzen möchtest."]]),
  ...featureQuests(["rifles"], ["Choose a game where you can use rifles.", "Wähle ein Spiel mit Gewehren."], [["rifle-single-bursts", ["focused", "challenge"], "Controlled Bursts", "During one familiar encounter, fire your rifle in **short bursts with a pause to aim between them**. Finish the encounter or stop after ten minutes.", "Kurze Feuerstöße", "Schieße in einem vertrauten Kampf mit deinem Gewehr **in kurzen Feuerstößen und ziele dazwischen neu**. Beende den Kampf oder hör nach zehn Minuten auf."], ["rifle-new-position", ["explore", "curious"], "A Different Angle", "Find **three different firing positions** in a familiar rifle encounter. Land one hit from each before moving on.", "Ein anderer Winkel", "Such dir in einem vertrauten Gewehrkampf **drei verschiedene Schusspositionen**. Lande von jeder Position einen Treffer."], ["rifle-familiar-run", ["relax", "nostalgic"], "Trusted Rifle", "Take **your most familiar rifle** into one repeatable encounter. Finish it without changing weapons or adjusting the loadout.", "Vertrautes Gewehr", "Nimm **dein vertrautestes Gewehr** in einen wiederholbaren Kampf mit. Beende ihn, ohne die Waffe oder Ausrüstung zu wechseln."]]),
  ...featureQuests(["bows"], ["Choose a game where you can use bows.", "Wähle ein Spiel mit Bögen."], [["bow-five-hits", ["focused", "progress"], "Five Arrows on Target", "Use a bow to land **five deliberate hits** on practice targets or familiar enemies. Take time to learn the arrow flight between shots.", "Fünf Pfeile im Ziel", "Lande mit einem Bogen **fünf gezielte Treffer** auf Übungsziele oder vertraute Gegner. Beobachte zwischen den Schüssen die Flugbahn der Pfeile."], ["bow-distance-study", ["curious", "explore"], "Arrow Flight", "Try **three different distances with the same bow**. Land one hit from each distance and notice how your aim changes.", "Die Flugbahn lesen", "Probiere **drei verschiedene Entfernungen mit demselben Bogen** aus. Lande aus jeder Entfernung einen Treffer und achte darauf, wie du zielen musst."], ["bow-only-encounter", ["challenge", "focused"], "String and Arrow", "Complete **one familiar encounter using only a bow**. Movement and defensive abilities are allowed; stop after the encounter or fifteen minutes.", "Sehne und Pfeil", "Schaffe **einen vertrauten Kampf nur mit einem Bogen**. Bewegung und defensive Fähigkeiten sind erlaubt. Hör nach dem Kampf oder nach fünfzehn Minuten auf."]]),
  ...featureQuests(["melee-weapons"], ["Choose a game where you can use melee weapons.", "Wähle ein Spiel mit Nahkampfwaffen."], [["melee-three-openings", ["focused", "challenge"], "Close Enough", "Use a melee weapon in **three encounters**. Wait for an opponent to miss before stepping in for your first attack each time.", "Nah genug", "Nutze in **drei Kämpfen eine Nahkampfwaffe**. Warte jedes Mal einen gegnerischen Fehlschlag ab, bevor du zum ersten Angriff ansetzt."], ["melee-unfamiliar-weapon", ["curious", "create"], "Different Reach", "Equip **one melee weapon you rarely use**. Try it against three familiar enemies and compare its reach with your usual weapon.", "Andere Reichweite", "Rüste **eine Nahkampfwaffe aus, die du selten nutzt**. Probiere sie an drei vertrauten Gegnern aus und vergleiche ihre Reichweite mit deiner üblichen Waffe."], ["melee-old-favorite", ["relax", "nostalgic"], "Back to the Blade", "Choose **your favorite melee weapon** and replay one familiar fight. Keep the same weapon throughout and stop after the fight.", "Zurück zur Lieblingswaffe", "Wähle **deine liebste Nahkampfwaffe** und wiederhole einen vertrauten Kampf. Bleib bei dieser Waffe und hör nach dem Kampf auf."]]),
  ...featureQuests(["fist-fights"], ["Choose a game where you can fight unarmed.", "Wähle ein Spiel mit Faustkämpfen."], [["fists-three-exchanges", ["focused", "progress"], "Three Exchanges", "In a practice fight or familiar encounter, complete **three unarmed attack exchanges**. Move back out of reach after each exchange.", "Dreimal zuschlagen", "Schaffe in einem Übungskampf oder vertrauten Kampf **drei unbewaffnete Schlagwechsel**. Geh nach jedem Schlagwechsel wieder auf Abstand."], ["fists-only-round", ["challenge", "restless"], "Empty Hands", "Complete **one familiar fight using only your fists**. Defensive movement is allowed; stop after the fight or ten minutes.", "Leere Hände", "Bestreite **einen vertrauten Kampf nur mit deinen Fäusten**. Ausweichen ist erlaubt. Hör nach dem Kampf oder nach zehn Minuten auf."], ["fists-read-opponent", ["curious", "low-energy"], "Read the Boxer", "Spend **one unarmed practice round observing two attack patterns**. In the next round, try to avoid each pattern once before striking back.", "Den Gegner lesen", "Achte in **einer unbewaffneten Übungsrunde auf zwei Angriffsmuster**. Versuche in der nächsten Runde, jedem Muster einmal auszuweichen, bevor du zurückschlägst."]]),
  ...featureQuests(["space-exploration"], ["Choose a game where you can visit planets.", "Wähle ein Spiel mit erkundbaren Planeten."], [["planet-three-details", ["explore", "curious"], "Another World", "Land on **one planet you have not visited**. Find three details about its terrain or wildlife before leaving.", "Eine andere Welt", "Lande auf **einem Planeten, den du noch nicht besucht hast**. Entdecke drei Besonderheiten der Landschaft oder Tierwelt, bevor du weiterfliegst."], ["planet-slow-walk", ["relax", "overwhelmed"], "Planet Walk", "On a safe planet, **walk away from your landing spot for five minutes**. Choose one view to pause at, then return to your ship.", "Spaziergang auf fremdem Boden", "Geh auf einem sicheren Planeten **fünf Minuten von deinem Landeplatz weg**. Bleib bei einer schönen Aussicht stehen und kehre dann zum Schiff zurück."], ["planet-compare", ["curious", "create"], "Worlds Apart", "Visit **two planets** and note one difference in their sky, terrain, and colors. Stop after your second landing.", "Zwei Welten", "Besuche **zwei Planeten** und merke dir je einen Unterschied am Himmel, im Gelände und bei den Farben. Hör nach deiner zweiten Landung auf."]]),
  ...featureQuests(["swimming"], ["Choose a game where you can swim and dive.", "Wähle ein Spiel mit Schwimmen und Tauchen."], [["swim-shore-route", ["explore", "relax"], "Along the Shore", "Swim **between two visible landmarks** along a safe shoreline. Stay close enough to land to finish without running out of breath.", "Am Ufer entlang", "Schwimme an einem sicheren Ufer **zwischen zwei sichtbaren Orientierungspunkten**. Bleib nah genug am Land, um rechtzeitig wieder Luft holen zu können."], ["dive-three-details", ["curious", "focused"], "Below the Surface", "Make **three short dives** in a safe area. Notice a different underwater detail on each dive and return to the surface between them.", "Unter der Oberfläche", "Mach in einem sicheren Gebiet **drei kurze Tauchgänge**. Achte jedes Mal auf ein anderes Detail unter Wasser und tauche zwischendurch zum Luftholen auf."], ["swim-return-trip", ["progress", "low-energy"], "There and Back", "Choose **one nearby point you can safely swim to**. Swim there and back without taking on another objective.", "Hin und zurück", "Wähle **einen nahen Punkt, den du sicher schwimmend erreichst**. Schwimme hin und zurück, ohne unterwegs ein anderes Ziel anzufangen."]]),
